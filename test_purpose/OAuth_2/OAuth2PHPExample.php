...
if (!isset($_GET["code"]))
{
    ...
    $authUrl = $client->getAuthorizationURL($authorizationRequestUrl, $scope, $redirect_uri, $response_type, $state);echo $authUrl;die('-');
...
else
{
    ...
    header("Location: http://development.justshipit.com/test_purpose/OAuth_2/index.php");
    exit();
