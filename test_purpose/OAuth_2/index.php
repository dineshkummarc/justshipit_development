...
<?php
  ...
  if(isset($_SESSION['access_token']) && !empty($_SESSION['access_token'])){
    ...
    echo "<br /> <a class='imgLink' href='".$configs['oauth_redirect_uri']."'><img style='height: 40px' src='C2QB_white_btn.png'/></a> <br />";
    ...
    echo "<a class='imgLink' href='".$configs['openID_redirect_uri']."'><img style='height: 40px' src='IntuitSignIn-lg.jpg'/></a>"; 
  }
 ?>
