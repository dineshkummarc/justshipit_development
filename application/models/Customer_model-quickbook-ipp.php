...
class Customer_model extends CI_Model
{
	...
	public function __construct()
    {
		...
		/* $this->dataService = DataService::Configure(array(
			'auth_mode' => 'oauth2',
			'ClientID' => "ABVD9f1wvB4zvafoy7IPM2V76h5OoubpUQohejTrKBnEUremtz",
			'ClientSecret' => "gDdhvw6zb9ognzY9GjB9AhwonuozP0ibxuubDXqN",
			'accessTokenKey' => 'eyJlbmMiOiJBMTI4Q0JDLUhTMjU2IiwiYWxnIjoiZGlyIn0..Yu5mswhCSgknhzbYlMzwrQ.u8gKKsg-SS-_pJnAkExIZ7H0E4cCycms-r4flnBekgmlhRa3EoH3ZtbYHfi2FljFO3WGGvzNI6GIWnQFwBqFzuCJuae6JSP_b6B8EIK7nFslsTEUbyJYnOUvWYUiUDVPLeMyLAoJHGQugccng-VaJXnAlsPZWrXuM7kP6D39MG7IwluSYtu-W4UW7f_aO3QI2f9ly_YxVNimZ_T2lmyzMiCEMY2xMXKvtCBkZ-LEYYj-axMSvHAMrk4mH1I_SNtmEiX5iYWYhLQdpQrxgUif-fEejxOOdqG-F5j7z7RzyhNFm8BceY8ViV6YoMXrPOpia92E6gbHoOdDIZ4oIk8wIqyrvjngTW9ONjejAentYK2F1sGC7FEMLOt06T8eFC3wMr9XPSd6CPljyBDv-8NePQoGlOaJ7ajk4tDRvp9Itv3SXuuBZ_RL24gzRD8H-RewF4u_iEAlxXsLXxcoZhypfgE83PVmvq5_sI58gppaJcfif4kFh_uJ-6v7ZAtBt2kU1TAnYk6J8JtL1TPdFSv1XANw7XsuU0Mvzc1K-n--fux-yFMrKox4pukyzA5bTT8yM25QjhZ6oHUZle_l463f9Vd4ZlDHz6z1QhkpOdYQdvFEzDm9j3deQeZAQlmJO5NskkMqDvmbukiG_-CBa9n9EK_ZZ9Q05T1idkIoNuaTRU8GnRmrjqFq-Px60rHCF08ttNHmne2998dC5MM9hnmi3u9NraCs8O8r5q6dXpCWaNk.-ZF-IwtF1NlL7p3KLFjQsA',
			'refreshTokenKey' => "AB11633008591ydOOmNgaeO0MMiO0VHyl6NTz99ZhESlut9j3Z",
			'QBORealmID' => "4620816365172153260",
			'baseUrl' => "development"
		));
	...
	function updateCustomertoQuickbook($userid){
		...
		if($userInfo->category_id == 2){
			...
			if(!empty($userInfo->quickbook_id)){
				$entities = $dataService->Query("SELECT * FROM Vendor where Id='".$userInfo->quickbook_id."'");
			}
		}else{
			$entities = $dataService->Query("SELECT * FROM Customer where DisplayName='".$userInfo->customer_name."'");
			if(!empty($userInfo->quickbook_id)){
				$entities = $dataService->Query("SELECT * FROM Customer where Id='".$userInfo->quickbook_id."'");
			}
		}
		*/
