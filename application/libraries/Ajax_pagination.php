...
class Ajax_pagination{
	...
	var $loading        = '.loadingico';
	var $extraParam     = array();
	...
	function create_links(){
        ...
        function getData(pageid){ 
			...
			var arrayFromPHP = <?php echo json_encode($this->extraParam); ?>;
			arrayFromPHP.page=pageid;
			  
            $.ajax({
                method: "POST",
                url: "<?php echo $this->base_url; ?>"+pageid,
                data: arrayFromPHP,
                beforeSend: function(){
	...
	function getAJAXlink($count, $text) {// echo json_encode($this->extraParam); die();
