              ...
              <div class="box">
                <div class="box-body table-responsive no-padding">
                  <table class="table table-hover">
                    ...
                    ?> 
                    <tr>
                        <td><a href="javascript:void(0);" onclick="chooseExtraChargeCode(<?php echo $record->charge_id;?>,'<?php echo $record->charge_code; ?>', '<?php echo $postData['idname'];?>', '<?php echo $record->description;?>');">Select</a></td>
