            ...
            <div class="col-md-12">
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" id="addAirport" action="<?php echo base_url() ?>saveAirport" method="post" role="form"> 
                        <div class="box-body">
                            <div class="row">
								<div class="col-md-6" >
									...
									<div class="form-group row">
										...
										<div class="col-sm-9">
											<input type="text" class="form-control required" value="<?php echo set_value('airport_name'); ?>" id="airport_name" name="airport_name" maxlength="128" autocomplete="off">
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-9">
											<input type="text" class="form-control required" value="<?php echo set_value('airport_code'); ?>" id="airport_code" name="airport_code" maxlength="4" autocomplete="off">
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-9">
											<input type="text" class="form-control required" value="<?php echo set_value('city'); ?>" id="city" name="city" maxlength="128" autocomplete="off">
										</div>
									</div>
										...
										<div class="col-sm-9">
										   <select class="form-control required com_state" id="com_state" name="com_state">
												...
												if(!empty($states))
												{
													...
													{
														?>
														<option value="<?php echo $st['state_id'] ?>" <?php if($st['state_id'] == set_value('com_state')) {echo "selected=selected";} ?>><?php echo $st['state_name'] ?></option>
														<?php
													}
												}
												?>
